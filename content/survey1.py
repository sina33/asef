...
help_message = (
    ...
    emoj(':small_blue_diamond:') +
    "در قسمت «حساب من» با لمس دكمه «عضويت»، از وضعيت اشتراكتان در روان‌یار مطلع شويد." + "\n\n" +
    emoj(':small_blue_diamond:') +
...
bot_intro_msg = (
    "روان‌یار با تحلیل ابعاد مختلف شخصیت و ارائه راهکارهای شخصی، به شما در شناخت و تعالی فردی کمک می‌کند" + "\n" +
    "با به اشتراک‌گذاری این پیام، روان‌یار را به دوستان خود معرفی کنید" + "\n\n" +
    "@ravanyaarbot" + "\n\n"
)